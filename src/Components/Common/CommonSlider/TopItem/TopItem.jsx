...
const TopItem = () => {
  ...
  const TopProduct = [
    ...
    // { Product: top4, name: "Electronics", items: Grocery },
    // { Product: top5, name: "Home & Furniture", items: Grocery },
    // { Product: top6, name: "Apllianecs", items: Grocery },
    // { Product: top7, name: "Flight Bookings", items: Grocery },
    // { Product: top8, name: "Beauty, Toys & More", items: Grocery },
    // { Product: top8, name: "Two Wheelers", items: Grocery },
  ];
