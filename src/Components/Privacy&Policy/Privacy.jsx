...
import styles from "./Privacy.module.css"; // Ensure this path is correct
...
const Privacy = () => {
  ...
  return (
    <div className={styles.term}>
      <div className={styles.terms_main} id="privacy">
        <p>
        ...
        {showBtn && (
          <button className={showBtn ? styles.show : ""} onClick={onTop}>
