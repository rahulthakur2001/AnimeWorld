...
import styles from "./Terms.module.css"; // Ensure this path is correct
  ...
  return (
    <div className={styles.term}>
      <div className={styles.terms_main}>
          <h2 id="terms-of-use">Flipkart Terms of Use</h2>
          <p>
          ...
          <p>
            ...
            Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru
            – 560103, Karnataka, India and its branch offices at 2nd Floor,
            Block F (Flora), Embassy Tech Village, Outer Ring Road,
            Devarabeesanahalli Village, Bengaluru-560103, Karnataka, India and;
            447/C, 12th Main, 4th Block, Koramangala, Bengaluru-560034,
          ...
          <p>
            ...
            to Flipkart's notice or if it is discovered that You are under the
            age of 18 years and transacting on the Platform.
          </p>
          ...
          <p>
            ...
            your login details, ie, username and password of Your account with
            any other person, else it would be considered breach of this Terms
            of Use.
          </p>
          <p>
          ...
          <p>
            ...
            through the same login username and password. You agree to have
            single login access to all the apps owned by Flipkart group
            companies.
          </p>
          <p>Communications</p>
          <p>
          ...
          <p>
            ...
            Platform. . Flipkart is not and cannot be a party to or control in
          ...
          <ol>
            <li>
              <p>
                ...
                services related to products and services. Flipkart does not
                have any control or does not determine or advise or in any way
                involve itself in the offering or acceptance of such
                commercial/contractual terms between the Buyers and Sellers. All
                discounts, offers (including exchange offers) are by the
                Seller/Brand and not by Flipkart.
              </p>
            </li>
            <li>
              <p>
                ...
                shall not be construed as Seller's acceptance of Buyer's offer
                to buy the product(s) ordered. The Seller retains the right to
                cancel any such order placed by the Buyer, at its sole
                discretion and the Buyer shall be intimated of the same by way
                of an email/SMS. Any transaction price paid by Buyer in case of
                such cancellation by Seller, shall be refunded to the Buyer.
                Further, the Seller may cancel an order wherein the quantities
                exceed the typical individual consumption. This applies both to
                the number of products ordered within a single order and the
                ...
                consumption quantity limit shall be based on various factors and
                at the sole discretion of the Seller and may vary from
            ...
            <li>
              <p>
                Flipkart is not responsible for any non-performance or breach of
                any contract entered into between Buyers and Sellers. Flipkart
                ...
                Flipkart shall not and is not required to mediate or resolve any
            ...
            <li>
              <p>
                ...
                etc) of any of its Users. You are advised to independently
                verify the bona fides of any particular User that You choose to
                deal with on the Platform and use Your best judgment in that
                behalf.
              </p>
            </li>
            <li>
          ...
          <p>
            * GST invoice will have, inter alia, the following details printed
            on it: -GSTIN associated with your registered business, as provided
            by you
          </p>
          ...
          <p>
            * For seamless availment of input tax credit, kindly mention the
            ...
            that availment of input tax credit is subject to provisions of GST
            Act and rules.
          </p>
          <p>
          ...
          <p>
            * Flipkart is not responsible to verify the correctness of the GSTIN
            and/or entity name provided by You and You shall be entirely
            responsible to provide the accurate details.
          </p>
          <p>
            * Flipkart and Seller shall not entertain any request for any
            revision in the GST Invoice. Flipkart and Seller shall not be liable
            for Your default including for reasons associated with details
            provided by You.
          </p>
          <p>
            * Flipkart will not be liable in case You are not able to avail
          ...
          <p>
            * You agree to indemnify and hold Flipkart and Seller harmless from
            all losses, claims, costs, expenses, suits, proceedings, or any
            other liability including any third-party claims (including any
            penalties imposed by governmental authorities) arising out of or in
            connection with (1) the GSTIN and/or entity name provided by you or
            the input tax credit claimed by you or your use or misuse of the GST
            Invoice and (2) your non-compliance with the applicable laws or (3)
            your use or misuse of any third-party’s details including GSTIN.
          </p>
          <p>
            * Flipkart has the right to not allow business purchases on the
          ...
          <ol>
            <li>
              You release and indemnify Flipkart and/or any of its officers and
              ...
              in that behalf, Flipkart cannot take responsibility or control the
              ...
              harmful, inconsistent, inaccurate, or deceptive. Please use
          ...
          <p>Charges</p>
          <p>
            Flipkart may charge a nominal fee for browsing and buying on the
            Platform. Flipkart reserves the right to change its Fee Policy from
            time to time. In particular, Flipkart may at its sole discretion
            introduce new services/fees and modify some or all of the existing
            services/fees offered on the Platform. In such an event, Flipkart
            ...
            are posted on the Platform. Unless otherwise stated, all fees shall
            be quoted in Indian Rupees. You shall be solely responsible for
            compliance of all applicable laws including those in India for
            making payments to Flipkart Internet Private Limited.
          </p>
          <p>What is the platform fee?</p>
          <p>
            Fee levied by Flipkart to sustain the efficient operations and
          ...
          <p>
            ...
            the complete order amount will be refunded if paid online, including
            the platform fee.
          </p>
          <p>
          ...
          <p>Convenience Fee (Flipkart Flights)</p>
          <p>
            For availing the travel booking services on the Platform, Flipkart
            reserves the right to charge certain fees in the nature of
            convenience fees or service fees in addition to the cost of booking
            as charged by the service providers. Flipkart further reserves the
            right to alter any and all fees from time to time. Any such
            additional fees, including fee towards any modifications thereof,
            will be displayed to customer before confirming the booking or
            collecting the payment from such customer. In the event of short
            charging of the booking amount, taxes, statutory fee, convenience
            fee etc., owing to any technical error or other reason, Flipkart
            shall reserve the right to deduct, charge or claim the balance
            amount from the customer and the customer shall pay such balance
            amount to Flipkart. In the event where the charge is claimed prior
            to the utilization of the booking, Flipkart will be at liberty to
            cancel such bookings if the amount is not paid before the
            utilization date. Flipkart is not responsible for any refunds in
            connection with any services offered by any person on the Flipkart
            platform (except for passing on such refunds when received from such
            persons to customers), other than refunds of convenience fees paid
            made to Flipkart for the services it provides to customers (subject
            to such refund requests being in compliance with these Terms and
          ...
          <p>
            ...
            related to the Platform. Throughout this Terms of Use, Flipkart's
            prior written consent means a communication coming from Flipkart's
          ...
          <ol>
            ...
            <li>
              <p>
                ...
                visitor to Platform, or any other customer, including any
                account on the Platform not owned by You, to its source, or
            ...
            <li>
              <p>
                ...
                name used by Us including the terms Flipkart, Flipcart,
                flipkart.com, or otherwise engage in any conduct or action that
                might tarnish the image or reputation, of Flipkart or sellers on
                platform or otherwise tarnish or dilute any Flipkart's trade or
                ...
                us. You agree that You will not take any action that imposes an
                unreasonable or disproportionately large load on the
                infrastructure of the Platform or Flipkart's systems or
                networks, or any systems or networks connected to Flipkart.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                shall be a violation of these Terms of Use to use any
                ...
                advertising or solicitation, We reserve the right to restrict
                the number of messages or emails which a user may send to other
                Users in any 24-hour period which We deems appropriate in its
          ...
          <p>
            ...
            materials posted on the Platform. Flipkart shall have the right to
            ...
            Content posted does not necessarily reflect Flipkart views. In no
            event shall Flipkart assume or have any responsibility or liability
          ...
          <ol>
            ...
            <li>
              <p>
                If you choose to browse or transact on the Platform using the
                voice command-based shoppingfeature, you acknowledge that
                Flipkart and/or its affiliates will collect, store and use your
                voice inputs on this feature to customize your experience and
                provide additional functionality as well as to improve
                Flipkart’s and/or its affiliates’ products and services.
                Flipkart’s and/or its affiliates’ use of your voice data will be
                in accordance with the Flipkart Privacy Policy. You accept that
                your use of this feature is restricted to the territory of the
                Republic of India. This feature may not be accessible on certain
                devices and requires an internet connection. Flipkart reserves
                the right to change, enhance, suspend, or discontinue this
                feature, or any part of it, at any time without notice to you.
                Your continued use of this feature constitutes your acceptance
            ...
            <li>
              <p>
                ...
                completeness or reliability. Under the translation feature, You
                will have the option to adding delivery addresses in the
                language selected by You out of the featured languages. Such
                delivery addresses shall be transliterated in English language
                for processing, handling and fulfilling Your orders on the
                Platform. Flipkart expressly disclaims any liability of any
                nature whatsoever arising from or related to the said
                translation/transliteration features on the Platform. Some
                features and sections on the Platform may not be translated in
                the language selected by You \[Hindi, Telugu, Tamil, Kannada,
                Marathi, Bengali, Gujarati, Odia, Malayalam, Punjabi &amp;
                Assamese language, as applicable\], and the English version of
                the same will be the definitive version. In the event of any
                conflict or inconsistency between the translated terms and the
                English version available on the Platform, the English version
                on the Platform shall prevail. This feature may not be
                accessible on certain devices. Flipkart reserves the right to
                change, enhance, suspend, or discontinue this feature, or any
                part of it, at any time without notice to You.
              </p>
            </li>
          </ol>
          ...
          <p>
            * The amount received as donation will be donated to NGOs and
            ...
            areas. You can visit www.flipkartfoundation.org to know more about
            this.
          </p>
          <p>* The contribution, once made, will not be refunded.</p>
          <p>
            * No certificate under section 80G of the Income Tax Act, 1961 will
            be issued.
          </p>
          <p>
          ...
          <p>
            * Flipkart Foundation disclaims any and all liability and assumes no
          ...
          <p>
            * By proceeding to donate the money, you consent and expressly waive
            ...
            otherwise) that you may have against any of the Flipkart Group
          ...
          <p>
            ...
            Information Technology Act 2000 and Rules there under. Our current
            Privacy Policy is available at Privacy. if You object to Your
          ...
          <p>
            ...
            to the forgoing paragraph, Flipkart does not warrant that:
          </p>
          <p>
          ...
          <p>
            Flipkart will not be liable to You in any way or in relation to the
            ...
            their servers; or electronic communication sent from Us are free of
          ...
          <p>
            ...
            We/Company will not be held liable for any delay in delivery of the
            Order.
          </p>
          <p>
          ...
          <p>
            ...
            Govt. issued ID and address proof) to establish the ownership of the
            payment instrument used by you for your purchase. This is done in
            the interest of providing a safe online shopping environment to Our
            Users.
          </p>
          <p>Further:</p>
          <ol>
            <li>
              <p>
                ...
                Buyer and Seller and payment facility is merely used by the
                Buyer and Seller to facilitate the completion of the
                Transaction. Use of the payment facility shall not render
                Flipkart liable or responsible for the non-delivery,
                ...
                fraud as regards the products and /or services listed on
                Flipkart's Platform.
              </p>
            </li>
            <li>
              <p>
                ...
                through Payment Facility. Your relationship with Flipkart is on
                a principal to principal basis and by accepting these Terms of
                Use you agree that Flipkart is an independent contractor for all
                purposes, and does not have control of or liability for the
                products or services that are listed on Flipkart's Platform that
                are paid for by using the Payment Facility. Flipkart does not
            ...
            <li>
              <p>
                ...
                provided by Flipkart is neither a banking nor financial service
                ...
                Transactions on the Flipkart Platform using the existing
          ...
          <ol>
            <li>
              <p>
                ...
                with the Seller to purchase the products and /or services from
                the Seller using the Payment Facility, and You shall pay the
            ...
            <li>
              <p>
                ...
                / increase in the Dispatch and/or Delivery time and the
                Transaction shall stand amended to such extent. Any such
                extension / increase of Dispatch / Delivery time or subsequent
                novation / variation of the Transaction should be in compliance
                with Payment Facility Rules and Policies.
              </p>
            </li>
            <li>
              <p>
                You, as a Buyer, shall electronically notify Payment Facility
                using the appropriate Flipkart Platform features immediately
                upon Delivery or non- Delivery within the time period as
                provided in Policies. Non notification by You of Delivery or
                non- Delivery within the time period specified in the Policies
                shall be construed as a deemed Delivery in respect of that
                Transaction. In case of Cash- On Delivery transactions, Buyer is
                not required to confirm the receipt of products or services.
              </p>
            </li>
            <li>
              <p>
                ...
                You do not receive the Delivery within the time period agreed in
                the Transaction or within the time period as provided in the
                Policies, whichever is earlier. In case you do not raise a
                refund claim using Platform features within the stipulated time
            ...
            <li>
              <p>
                ...
                be made at the same Issuing Bank from where Transaction Price
                was received, or through any other method available on the
                Platform, as chosen by You.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                alternate bank account details with us for processing the
                refund.
              </p>
            </li>
            <li>
              <p>
                ...
                to Flipkart in case of any misuse by Buyer.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                Transactions or Transaction Price which Flipkart may receive
                ...
                of payment or by an individual Buyer during any time period, and
            ...
            <li>
              <p>
                ...
                Flipkart or breach/violation of any law or any charges imposed
            ...
            <li>
              <p>
                ...
                other reasons at the discretion of Flipkart. As a result of such
                check if Flipkart is not satisfied with the creditability of the
                Buyer or genuineness of the Transaction or other reasons at its
                sole discretion, Flipkart shall have the right to reject the
                receipt of / Buyers commitment to pay Transaction Price. For
                avoidance of doubt, it is hereby clarified that the ‘Cash on
                Delivery’ feature for payment, may be disabled for certain
                account users, at the sole discretion of Flipkart.
              </p>
            </li>
            <li>
              <p>
                Flipkart may delay notifying the payment confirmation i.e.
                informing Seller to dispatch, if Flipkart deems suspicious or
                for Buyers conducting high transaction volumes to ensure safety
                of the Transaction and Transaction Price. In addition, Flipkart
                may hold Transaction Price and Flipkart may not inform Seller to
                Dispatch or remit Transaction Price to law enforcement officials
                (instead of refunding the same to Buyer) at the request of law
                enforcement officials or in the event the Buyer is engaged in
          ...
          <ol>
            <li>
              <p>
                As required by applicable law, if the Customer makes a purchase
                of an amount equal to or above INR 2, 00, 000.00/- the Customer
                will be required to upload a scanned copy of his/her PAN card on
                the Platform, within 4 days of making the purchase, failing
                which, the purchase made by the Customer will be cancelled. The
                requirement to submit the PAN card arises only once and if it
                has been submitted already by the Customer, it need not be
                submitted again. The order of the Customer shall stand cancelled
                if there is a discrepancy between the name of the Customer and
          ...
          <ol>
            <li>
              <p>
                ...
                be governed by the terms and conditions agreed between the Buyer
                and the respective Issuing Bank and payment instrument issuing
                company.
              </p>
            </li>
            <li>
          ...
          <p>Terms:</p>
          <p>
            A) Flipkart fosters diversity, inclusion, equity and protect the
            ...
            ethnicity, nationality, gender, gender identity and expression,
            sexual orientation, disability, religion or belief, age or any other
            grounds.
          </p>
          <p>
            B) Flipkart prohibits discrimination against delivery partners under
            any circumstances and on any grounds including on the basis of race,
            religion, caste, place of origin, disability, sexual orientation,
            sex, marital status, gender identity, age, or any other
            characteristics that may be protected under applicable law.
          </p>
          <p>
            C) We reserve the right to withhold access to the Platform and
            otherwise limit Your access to the Platform at Our absolute
            discretion if You behave towards any delivery partner working with
            Flipkart in a manner which is discourteous, disrespectful, or
          ...
          <p>
            Flipkart's Replacement Guarantee seeks to assist Buyers who have
            been defrauded by qualified sellers on the Platform. The return
            policy period (Flipkart's Replacement Guarantee) depends on the
          ...
          <ol>
            <li>
              <p>
                ...
                delivery of the product/s and/or within the applicable return
                policy period and the same product/s will be replaced in return
          ...
          <p>
            ...
            category (includes clothing, footwear, etc.) are meanwhile covered
            by the 30 Day Replacement Guarantee. Kindly click here to know the
            return policy period (Replacement Guarantee) applicable for
            different categories.
          </p>
          <p>
            If Flipkart has any suspicion or knowledge that any of its buyers
            and sellers are involved in any activity that is intended to provide
            claims or information that is false or not genuine, Flipkart may
            ...
            Flipkart will not be allowed to return their products.
          </p>
          <p>
            ...
            addition to the legal proceedings as aforesaid, Flipkart may at its
            sole discretion suspend, block, restrict, cancel the Display Name
            \[and its related Display Names\] of such user and/or disqualify
            that user and any related users from availing protection through
            this program. Any person who, knowingly and with intent to injure,
          ...
          <p>
            I confirm that device which I am exchanging under the buyback
          ...
          <p>
            ...
            future buyer of the device against all or any third party claims,
            demand, cost, expenses including attorney fees which may be
            suffered, incurred, undergone and / or sustained by Flipkart.com,
            its affiliates or any future buyer due to usage of the device by you
            till date and you undertake to make good the same.
          </p>
          <p>
            I confirm that all the data in the said device will be erased before
            handing it over under buyback program. I also confirm that in spite
            of erasing the data manually/electronically, if any data still
            accessible due any technical reason, Flipkart.com, Seller or the
            manufacturer shall not be responsible for the same and I will not
            approach Flipkart.com for any retrieval of the data.
          </p>
          <p>
            ...
            in managing the program for the purposes of validating the
            information that I provided herein and for the administration of the
            program.
          </p>
          <p>
            I agree to indemnity and keep indemnifying the Flipkart.com and any
            future buyer of the old device against all or any third party
            claims, demand, cost, expenses including attorney fees which may be
            suffered, incurred, undergone and / or sustained by Flipkart.com,
            its affiliates or any future buyer due to usage of the device by me
            till date and I undertake to make good the same.
          </p>
          <p>
            I understand once a device is sent by me to Flipkart, in no scenario
            can this device be returned back to me.
          </p>
          <p>
          ...
          <ol>
            <li>
              <p>
                ...
                of Flipkart Video which is an online over-the-top platform
                providing users with live and/or on-demand audio and video
                content of various genres which may be offered by either
                Flipkart or by third party content providers (all such content,
            ...
            <li>
              <p>
                ...
                ("Platform"), that is owned and operated by Flipkart Internet
                Private Limited ("Flipkart", "We" or "Our").
              </p>
            </li>
            <li>
              <p>
                This document sets out the terms and conditions in connection
                with your use of the Platform and, subsequently, your access to
                and/or consumption of the Content and/or other related services
                provided on the Platform (all such content and services,
                collectively, "Services" and such terms and conditions, the
                "Terms" ).
              </p>
            </li>
            <li>
              <p>
                Use of Flipkart Services is available only to persons who can
                form a legally binding contract under the Indian Contract Act,
                1872.You must be 18 years of age, to avail the Services. Minors
                may only use the service under the supervision of an adult. Some
                content offered on the Platform may not be appropriate for
                viewership by minors. Accordingly, parents and/or the guardians
                of such children or minors are advised to exercise discretion
                before allowing their children or minors to access such content
                on the Platform.
              </p>
            </li>
            <li>
              <p>
                All the Content being offered to the users on the Platform shall
                be, for the convenience of the users, free of cost, or at such
                other terms as may be offered by Flipkart or the Content
                Providers with respect to any Content from time to time, and
                such other terms shall be communicated to the user at the time
                of viewing such Content and/or at the time of registering with
                the Platform. Subject to you accepting these Terms and any other
                terms as may be communicated to you from time to time, you are
                given a limited, non-exclusive, non-transferable,
                non-sub-licensable, revocable permission to view the Platform
                and avail the Services during the subsistence of your account
                with Flipkart and no right, title or interest in any Content
                will be deemed transferred to you.
              </p>
            </li>
            <li>
              <p>
                The Platform is an interactive online platform for the users to
                view the Content of various genres, which may either be offered
                by Flipkart or third party content providers. As regards third
                party audio-video content generated by third parties (such
                content, the " Third Party Content" and such content providers,
                the " Content Owners"), the Platform offers you such Third Party
                Content by providing hosting services to Content Owners
                displaying their content and/or by allowing their content to be
                ...
                Partners") who may have content procurement arrangements with
                the Content Owners The Platform may also provide content which
                is commissioned by Flipkart and/or is procured by Flipkart
                either under a license or copyright agreement (such content, "
                Flipkart Originals").
              </p>
            </li>
            <li>
              <p>
                Content will therefore consist of Flipkart Originals or Third
                Party Content. Content Owners and/or Platform Partners will
                provide Third Party Content. Specifically, for more information
                in relation to Third Party Content (including the terms of use
                relating specifically to Third Partner Content), you may refer
                to their respective terms and conditions. As such, Flipkart has
                no ownership or control whatsoever on Third Party Content,
                whether it is uploaded or streamed by Content Owners or by the
                Platform Partners. Flipkart plays no role in creating/developing
                Third Party Content.
              </p>
            </li>
            <li>
              <p>
                ...
                strictly limited to providing a uniform resource locator (URL)
                or a web-address to access and/or share such content on the
                Internet with the users and all news content is provided,
                uploaded, streamed and/or hosted by Content Owners, the Platform
                Partners and/or their respective agents or service providers.
                For avoidance of doubt, it is clarified that Flipkart will not
                be hosting, uploading or streaming any news content on its
                servers or IT systems. Flipkart will not be exercising any
                control – physical, editorial or digital - over the news Content
                being viewed by or provided to the user on the Platform.
                Flipkart will only be providing the user with an option and/or a
                medium to access news content through the Platform which, in
                turn, will provide the Content Providers and/or the Platform
                Partners an opportunity to disseminate their content on the
                Platform. The news Content on the Platform is directly uploaded
                or streamed onto the Platform by Platform Partners who avail of
                Flipkart's communication platform, without any intervention from
                Flipkart in the content
                procurement/uploading/streaming/transmission process. Flipkart's
                role is that of an 'intermediary' as defined under the
                Information Technology Act, 2000 and the rules thereunder, with
                regard to the news Content. Being an intermediary, Flipkart has
                no responsibility and/or liability in respect of any news
                Content on the Platform, including for intellectual property
            ...
            <li>
              <p>
                Irrespective of whether the Content is a Third Party Content or
                a Flipkart Original, you, at all times, are responsible for your
                use of the Platform and for viewing any Content and Flipkart
                shall have no liability with respect to any loss or damage
                caused by viewing or relying on the Content. By hosting Flipkart
                Originals on the Platform and by permitting the hosting,
                uploading or streaming of Third Party Content on the Platform,
                Flipkart will neither guaranteeing nor giving any warranty nor
                making any representation with respect to the Contents. The
                Content provided on the Platform is for entertainment or
                information purposes only and Flipkart will neither be endorsing
                the views, products or the services being depicted or offered as
                part of the Content, nor will Flipkart be responsible for
                quality or features of the Content displayed on the Platform.
                Unless expressly stated otherwise, all characters, themes and
                events depicted in Flipkart Originals are entirely fictitious
                and any similarity to actual events or persons, living or dead,
                is purely coincidental, unintentional or accidental.
              </p>
            </li>
            <li>
              <p>
                Third Party Content will be made available to you through
                different modes, including via video-on-demand or on a live
                streaming basis, depending on the nature of the content and at
                the discretion of the Content Owners and/or Platform Partners.
                Flipkart Originals will be provided to you through different
                modes as well as the discretion of Flipkart. You may choose to
                view any Content at your discretion at a time chosen by you and
                by accepting these Terms and any other terms relating to such
                Content.
              </p>
            </li>
            <li>
              <p>
                ...
                access, the Content or some part of the Services, (a) is subject
                to applicable law and the contractual arrangements between
                Flipkart and the Content Owners and/or Platform Partners; and
                (b) may be dependent upon your geographical location, your
                Internet/data connectivity or your system capabilities or
                compatibility with the Platform. Not all Content or Services
                will be available to all users. On account of the nature of the
                Internet/data connectivity and system compatibility, the
                Platform and the Services may also be accessed in various
                geographical locations. You, therefore, hereby agree and
                acknowledge that you are accessing the Platform and availing of
                the Services, at your own risk, choice and initiative, and you
                agree and undertake to ensure that your use of the Platform and
                ...
                quantity of your access to the Content or the use of the
                Platform or availing of the Services would be subject to various
                parameters such as specifications, device, Internet availability
                and speed, bandwidth, etc.
              </p>
            </li>
            <li>
              <p>
                Any information on the Platform, whether the Content or any
                other information (other than Flipkart Original), have not been
                verified by Flipkart, and therefore, Flipkart shall not be
                responsible for any such Third Party Content or information.
                Flipkart will not bear any obligation or liability if You rely
                on the Contents or information and any loss or liability has
                been incurred by you arising from such Third Party Content or
                information.
              </p>
            </li>
            <li>
              <p>
                ...
                information, as offered by the Content Providers and/or the
                Platform Partners, and Flipkart will neither be a party to such
                an arrangement nor will it in any manner be concerned with such
                an arrangement nor will Flipkart be liable or responsible for
                any act or omission of the Content Owner and/or the Platform
                Partners.
              </p>
            </li>
            <li>
              <p>
                You hereby acknowledge that the Third Party Content is created
                and owned by the Content Owners who own all the rights including
                the copyrights with respect to such content. The Content is
                available on the Platform for personal and non-commercial use
                only and you shall not use it for any commercial, promotional,
                resale, further distribution or any other unauthorized purposes.
            ...
            <li>
              <p>
                ...
                rights contained in (a) the Flipkart Originals are solely owned
                by Flipkart and (b) in the Third Party Content are solely owned
                by the Content Owners or licensed to the Platform Partners.
                During the term of your Flipkart membership we grant you a
                limited, non-exclusive, non-transferable, revocable right to
                access the Platform and view the Content. Except for the
                foregoing, no right, title or interest shall be transferred to
                you in any Content or the Platform.
              </p>
            </li>
            <li>
              <p>
                We can terminate your account or place your account on hold in
                order to protect our or the interests of the Content Owners or
                of the Platform Partners, from an actual, probable or suspected
                theft, loss, damage or other fraudulent activity. Flipkart
                reserves the right to immediately terminate, suspend, limit, or
                restrict your access or use of the Platform and/or the Services,
                at any time, without any notice or liability, if Flipkart so
                determines, in its sole discretion, for any reason whatsoever,
                including that you have: (a) breached these Terms or the Privacy
                Policy; or (b) violated any applicable law, rule, or regulation;
                or (c) you have engaged in any inappropriate or unlawful
                conduct; or (d) provided any false or inaccurate information; or
                (e) for any other reason that Flipkart deems fit in its sole
                discretion.
              </p>
            </li>
            <li>
              <p>
                ...
                on the Platform or endorse any opinions expressed via the
                Contents. You understand that by using the Platform, you may be
                exposed to Content that might be offensive, harmful, inaccurate
                or otherwise inappropriate, or in some cases, postings that have
                been mislabeled or are otherwise deceptive. All Third Party
                Content is the sole responsibility of the Content Owners who
                originated such content or it is the responsibility of the
                Platform Partners who host, upload and/or stream such Third
                Party Content. Flipkart may not monitor or control the Content
                posted, uploaded and/or streamed on the Platform by the Content
                Owners, the Platform Partners and/or their respective agents or
                affiliates, and, we do not take responsibility or liability for
                any such content.
              </p>
            </li>
            <li>
              <p>
                ...
                violates these Terms or the applicable law, including for
                example, copyright or trademark violations, impersonation,
                unlawful conduct, or harassment. With respect to Third Party
                Content, Flipkart's role is limited to providing a communication
                platform to Content Owners and/or Platform Partners, to enable
                the transmission of the Third Party Content directly from such
            ...
            <li>
              <p>
                ...
                location or an account email address used with an existing
                Flipkart account to determine eligibility and any offers therof.
                We may share personal information with our other corporate
                entities and Platform Partners only for the purposes of giving
            ...
            <li>
              <p>
                ...
                information with third parties unless you specifically opt out.
                In addition, your access to the Services and the Platform may
            ...
            <li>
              <p>
                ...
                Platform, you can report it to customer care of Flipkart.
              </p>
            </li>
            <li>
              <p>
                Disclaimer of representations and warranties: Your access to and
                use of the Services or any Content are at your own risk. You
                understand and agree that the Services are provided to you on an
                "AS IS" or "AS AVAILABLE" basis. Flipkart makes no warranty or
                representation and disclaim all responsibility and liability
                for: (i) the completeness, accuracy, availability, timeliness,
                security, security and non-compatibility or reliability of any
                Content; (ii) any harm to your computer system, loss of data, or
                other harm that results from your access to or use of any
                Content; (iii) the deletion of, or the failure to store or to
                transmit, any Content and other communications maintained by the
                Services; and (iv) whether the Services will meet your
                requirements or be available on an uninterrupted, secure, or
                error-free basis. No advice or information, whether oral or
                written, obtained through the Content, will create any warranty
                or representation not expressly made herein or therein.
              </p>
            </li>
            <li>
              <p>
                Limitation of liability: By using the Services, you agree that
                the liability of Flipkart, its parents, affiliates, related
                companies, officers, directors, employees, agents,
                representatives, partners and licensors, shall be limited to the
                maximum extent permissible by applicable law. In no case shall
                Flipkart, its directors, officers, employees, affiliates,
                agents, contractors, principals, or licensors be liable for any
                direct, indirect, incidental, punitive, special, or
                consequential damages arising from your use of the Services or
                any Content or for any other claim related in any way to your
                access to the Platform and/or use of the Services, including,
                but not limited to, any errors or omissions in any Content or
                information on the Platform, or any loss or damage of any kind
                incurred as a result of the use of the Services and/or reliance
                on any Content or information on the Platform.
              </p>
            </li>
            <li>
              <p>
                ...
                partners (as applicable), and their respective officers,
                directors, agents, and employees (" Indemnified Parties"), from
                and against any claim, demand, damages, obligations, penalty,
                losses or actions (including reasonable attorneys' fees) made by
                any third party against the Indemnified Parties or imposed
                against the Indemnified Parties, due to or arising out of your
                or your affiliate's or relative's: (a) breach of these Terms,
                the Privacy Policy and/or any other policies; or (b) violation
                of any applicable law, rules, regulations; or (c) violation of
                the rights (including infringement of intellectual property
                rights) of a third party or Flipkart; or (d) unauthorized,
                improper, illegal or wrongful use of your Flipkart account
                (including by you or by any person, including a third party,
                whether or not authorized or permitted by you). This
                indemnification obligation will survive the expiry or
                termination of these Terms and/or your use of the Service.
              </p>
            </li>
            <li>
              <p>
                Force Majeure: You agree that Flipkart shall be under no
                liability whatsoever to you in the event of non-availability of
                the Platform and/or any of the Services or any portion thereof,
                occasioned by an Act of God, war, disease, revolution, riot,
                civil commotion, strike, lockout, flood, fire, satellite
                failure, failure of any public utility, man-made disaster,
                satellite failure or any other cause whatsoever beyond the
                control of Flipkart (including any event which is caused by the
                failure or non-performance on the part of the Content Owners or
            ...
            <li>
              <p>
                ...
                to the conflict of law provisions and for resolution of any
                dispute arising out of your use of the Services or in relation
                to these Terms. Notwithstanding the foregoing, you agree that
                (i) Flipkart has the right to bring any proceedings before any
                court/forum of competent jurisdiction and you irrevocably submit
                to the jurisdiction of such courts or forum; and (ii) any
                proceeding brought by you shall be exclusively before the courts
                in Bengaluru, India.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                prior notice to you, to update, revise, supplement, and
                otherwise modify these Terms and to impose new or additional
                rules, policies, terms, or conditions on your use of the
                Service. Any updates, revisions, supplements, modifications, and
                additional rules, policies, terms, and conditions will be posted
                on the Platform and will be effective immediately after such
                posting and we recommend that you periodically check these Terms
                on the Platform for such revised terms. Your continued use of
                the Services and/or the Platform will be deemed to constitute
                your acceptance of any and all such revised terms.
              </p>
            </li>
            <li>
              <p>
                Entire agreement: These Terms, the Privacy Policy and any other
                terms or policies as may be prescribed by Flipkart from time to
                time, constitute the entire agreement between you and Flipkart,
                which will govern your use of or access to the Services and/or
                the Platform, superseding any prior agreements between you and
                Flipkart regarding such use or access.
              </p>
            </li>
            <li>
              <p>
                ...
                termination of these Terms (including but not limited to Clauses
          ...
          <p>
            ...
            other than India do so on their own initiative and Flipkart is not
          ...
          <p>
            This site is controlled and operated by Flipkart and products are
            ...
            by copyrights, trademarks, and other intellectual property rights.
            ...
            assist any other person to do so. Without the prior written consent
            of the owner, modification of the materials, use of the materials on
            any other Platform or networked computer environment or use of the
          ...
          <p>
            You can purchase e-books through Flipkart. You can obtain unlimited
            access to the e-books.
          </p>
          <p>
            Rights Granted: E-book right is a non-exclusive, non-transferable
            right to use for your personal, non-commercial use, subject to and
            in accordance with the Terms of Use. You must not share access to
            the e-books with any other person.
          </p>
          <p>
            Flipkart does not assume any loss or damage caused by Your
            electronic gadget with which You are viewing the e-book or if the
            electronic gadget does not support the e-book application.
          </p>
          <p>
          ...
          <p>
            Intellectual Property Rights: It is hereby specifically recorded
            that the copyright and other Intellectual Property in the e-book is
            ...
            third parties to sell the e-book on the Platform for license of use
            to the end customers. Intellectual Property Rights for the purpose
            of this Terms of Use shall always mean and include copyrights
            ...
            available under applicable law shall vest in the domain of Flipkart
            ...
            in the absolute ownership, possession and Flipkart’s control or
          ...
          <p>
            Flipkart we do not warrant that Product description or other content
            of this Platform is accurate, complete, reliable, current, or
          ...
          <p>
            ...
            <a href="https://www.flipkart.com/helpcentre\]\[https\_www.flipkart.com\_helpcentre\">
              https://www.flipkart.com/helpcentre\]\[https\_www.flipkart.com\_helpcentre\
            </a>
            ].
          </p>
          ...
          <p>
            Flipkart prohibits the use of language that is racist, hateful,
          ...
          <p>
            ...
            words are part of a title for the item being sold, we allow Sellers
            to 'blur' out the bulk of the offending word with asterisks (i.e.,
            s\*\*\* or f\*\*\*).
          </p>
          <p>
          ...
          <p>
            Flipkart will consider the circumstances of an alleged policy
          ...
          <p>
            Flipkart shall have the right to delete a product review posted by
            ...
            Flipkart is of the opinion that the review unfairly either: (i)
            causes disadvantage to a product; or (ii) increases the popularity
            of the product, Flipkart shall have the right to delete the customer
            review. Flipkart shall also, at its sole discretion have the right
          ...
          <p>
            If Flipkart has suspicion or knowledge, that any of its buyers and
            ...
            Flipkart may while reserving its rights to initiate civil and/or
          ...
          <p>
            ...
            request by contacting Us on Our Toll Free Number, Seller while
            closing the return ticket can select one of the following:
          </p>
          <ol>
            <li>
          ...
          <p>
            In case the Seller doesn't close the ticket in 3 days from the date
          ...
          <p>Overview</p>
          <p>
            Generally, transactions are conducted smoothly on Flipkart. However,
            there may be some cases where both the Buyers and Sellers may face
            issues. At Flipkart, we have a Dispute Resolution process in order
          ...
          <p>
            ...
            Buyer raises a dispute, then Flipkart will try to mediate and
          ...
          <p>
            ...
            or a replacement, Flipkart will actively work towards reaching a
            resolution.
          </p>
          <p>
          ...
          <p>
            ...
            if the Buyer has been blacklisted/blocked from making purchases on
            the Platform. Only after verifying these facts, a dispute can be
            registered.
          </p>
          <p>
          ...
          <p>
            When a dispute has been raised, Flipkart may provide both the
            ...
            Flipkart for settling the dispute.
          </p>
          <p>Buyer Eligibility and Restrictions</p>
          <p>
            Only the Buyers who have purchased the product on Flipkart are
          ...
          <p>
            ...
            with Flipkart by contacting us through the link:{" "}
            <a href="https://www.flipkart.com/helpcentre">
              https://www.flipkart.com/helpcentre
            </a>
          </p>
          ...
          <p>
            ...
            Flipkart. If the claim was withdrawn, it is not counted. The
            coverage amount will be limited to Rs. 50,000/-
          </p>
          <p>
            Through the Buyer Protection program, Flipkart does not provide any
            guarantee/warranty to Buyers for products sold on Flipkart against
          ...
          <p>
            Flipkart shall at no point be responsible for any direct or indirect
          ...
          <p>
            Decisions made by Flipkart under the Buyer Protection Program shall
            be final and binding on its Users.
          </p>
          <p>
            Flipkart reserves the right to modify / discontinue Buyer Protection
            Program without any prior notice period to its Users.
          </p>
          <p>
            Through this program, Flipkart shall not entertain claims of Buyers
            who have incurred loss due to delayed shipment or delivery of the
            item by the Seller.
          </p>
          <p>
            Flipkart Customer Support Team may seek additional information /
          ...
          <p>
            ...
            Flipkart" and failing to do so Seller will be liable for chargebacks
            (as applicable).
          </p>
          <ol>
            <li>
          ...
          <p>
            ...
            regulated by Flipkart. Flipkart encourages its Users to be
            professional, courteous and respectful when communicating by email.
          </p>
          <p>
            However, Flipkart will investigate and can take action on certain
            types of unwanted emails that violate Flipkart policies.
          </p>
          <p>Such instances:</p>
          <p>
            Threats of Bodily Harm - Flipkart does not permit Users to send
            explicit threats of bodily harm.
          </p>
          <p>
            Misuse of Flipkart System - Flipkart allows Users to facilitate
            transactions through the Flipkart system, but will investigate any
          ...
          <p>
            Spam (Unsolicited Commercial email) - Flipkart's spam policy applies
            only to unsolicited commercial messages sent by Flipkart Users.
            Flipkart Users are not allowed to send spam messages to other Users.
          </p>
          <p>
            Offers to Buy or Sell Outside of Flipkart - Flipkart prohibits email
            offers to buy or sell listed products outside of the Flipkart
            Platform. Offers of this nature are a potential fraud risk for both
            Buyers and Sellers.
          </p>
          <p>
            Flipkart policy prohibits user-to-user threats of physical harm via
          ...
          <p>
            Flipkart does not take responsibility or liability for the actions,
            ...
            businesses for which, Flipkart assumes no responsibility for
            examining or evaluating the products and services offered by them.
            Flipkart do not warrant the offerings of, any of these businesses or
            individuals or the content of such third party Platform(s). Flipkart
          ...
          <p>
            Flipkart has put in place Flipkart Infringement Verification process
            so that intellectual property owners could easily report listings
            that infringe their rights. It is in Flipkart's interest to ensure
            that infringing products are removed from the site, as they erode
            Buyer and good Seller trust.
          </p>
          <ul>
            <li>
              If you are a Verified Rights Owner and want to report a listing
              issue, see Flipkart's FIV. Note: Only the intellectual property
              rights owner can report potentially infringing products or
              listings through FIV. If you are not the intellectual property
              rights owner, you can still help by getting in touch with the
              rights owner and encouraging them to contact us.
            </li>
            <li>
          ...
          <p>
            Flipkart does not and cannot verify that Sellers have the right or
            ability to sell or distribute their listed products. However,
            Flipkart is committed to removing infringing or unlicensed products
            once an authorized representative of the rights owner properly
            reports them to Flipkart.
          </p>
          <p>
          ...
          <p>
            ...
            as a copyright, trademark or patent) which may be infringed upon by
            products listed on Flipkart is encouraged to become a FIV member.
          </p>
          <p>
          ...
          <ul>
            <li>
              Rapid response by Flipkart in ending listings reported by you (as
              the Verified Rights Owner) as allegedly infringing
            </li>
            <li>
            ...
            <li>
              The ability to obtain identifying information about Flipkart's
              users'
            </li>
          </ul>
          <p>How to Become a FIV Member</p>
          <p>
            To join the FIV, we require only that you fully complete and email
            ...
            authorized signature. The information requested by the Notice of
            Infringement is designed to ensure that parties reporting products
            are authorized by the rights owners, and to enable Flipkart to
            easily identify the material or listing to be ended.
          </p>
          <p>
            In the interest of keeping the process easy and simple, after we
            receive your first Notice of Infringement in hard copy, future
            notices can be sent to Us by email at ss@flipkart.com.
          </p>
          <p>
            Note: In your notice of infringement, you shall be required to
            identify the individual listing which is infringing your
            intellectual property. General notices shall not be accepted.
          </p>
          <p>
            We are happy to receive such information, but must advise that we
            may be limited in Our ability to respond to your request absent
            formal notice from an authorized rights owner.
          </p>
          ...
          <ol>
            ...
            <li>
              ...
              identified in the annexure attached hereto are not authorised by
              the above IP Owner, its agent, or the law and therefore infringe
              the IP Owner's rights. Please expeditiously remove or disable
              access to the material or products claimed to be infringing.
            </li>
          ...
          <p>
            ...
            inform Sellers of the specific reason for the removal of their
            products.
          </p>
          <p>
          ...
          <ol>
            ...
            <li>
              Listing(s) comprises unauthorized copy of copyrighted image and
              text
            </li>
          </ol>
          <p>
          ...
          <p>
            ...
            accessing the seller related information made available by the
            sellers on their product listing pages. Alternatively, the buyers
            may also reach out to customer support at 044-45614700 or access
            help center at{" "}
            <a href="https://www.flipkart.com/helpcentre">
              https://www.flipkart.com/helpcentre
            </a>
